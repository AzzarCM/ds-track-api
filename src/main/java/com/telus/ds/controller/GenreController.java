...
public class GenreController {
	...
	private Genre convertToEntity(GenreDTO genreDTO) {
        ...
        @GetMapping("/getGenre")
	public GenreDTO getGenre(@RequestParam("genre_id") String genre_id) {
		
		Genre genreFound = genreService.getGenre(genre_id);
		
		if (genreFound == null) {
			throw new ResourceNotFoundException("Genre not found in DS repository with Genre_id=" + genre_id);
		}
